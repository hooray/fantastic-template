import{_ as a,c as i,a4 as n,o as e}from"./chunks/framework.P-2qlsVc.js";const o=JSON.parse('{"title":"环境配置","description":"","frontmatter":{},"headers":[],"relativePath":"guide/configure.md","filePath":"guide/configure.md"}'),l={name:"guide/configure.md"};function p(t,s,h,k,d,c){return e(),i("div",null,s[0]||(s[0]=[n(`<h1 id="环境配置" tabindex="-1">环境配置 <a class="header-anchor" href="#环境配置" aria-label="Permalink to &quot;环境配置&quot;">​</a></h1><p>默认提供三套环境配置，分别为：</p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-_z_wP" id="tab-0rT2KUe" checked><label data-title=".env.development 开发环境" for="tab-0rT2KUe">.env.development 开发环境</label><input type="radio" name="group-_z_wP" id="tab-uzNkxIq"><label data-title=".env.test 测试环境" for="tab-uzNkxIq">.env.test 测试环境</label><input type="radio" name="group-_z_wP" id="tab-4LkQm73"><label data-title=".env.production 生产环境" for="tab-4LkQm73">.env.production 生产环境</label></div><div class="blocks"><div class="language-yaml vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">yaml</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 页面标题</span></span>
